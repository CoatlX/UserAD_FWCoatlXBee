<?php 
 ...
 Class Csrf{
    ...
    private $token;//Token
    private $token_expiration;//Tiempo de expiración de nuestro token
    private $expiration_time =60*5;//5 minutos para que expire
    ...
    private function generate(){
        if(function_exists('bin2hex')){
            ...
            $this->token = bin2hex(openssl_random_pseudo_bytes($thos->length));
        }
    ...
    /**
     * Validar el token de la petición con el sistema
     * 
