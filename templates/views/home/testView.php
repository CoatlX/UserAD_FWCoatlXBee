...
<div class = "container">
    <div class="row">
        <div class="col-6 text-center offset-xl-3">
           <img src="<?php echo IMAGES.'coatlx-logo-mod.png' ?>" alt="CoatlX" 
            style = "width: 200px;">
            <h2 class="text-dark mt-2 mb-3"><span class="text-danger">CoatlX</span> Framework</h2>
            <p class="text-center text-dark"> Un framework hecho en casa, con pasión y mucho cariño.
                ...
                <div class="mt-5">
                    <p class="text-dark">Desarrollado con <i class="fas fa-heart text-danger"></i> por 
                <a href="http://bit.ly/udemy_joystick" class="text-dark">Joystick - Gracias Bobby</a></p>
                </div>
        </div>
    </div>
</div>
